# -*- coding: utf-8 -*-
"""
Created on Wed Apr 10 16:16:50 2024
...
Jee = np.arange(0,2.01,0.1)
Jei = np.arange(0,2.01,0.1)

Vals=[(v1,v2) for v1 in Jee for v2 in Jei]
# Vals=[(v2) for v2 in Jee]
isim=0
...
# initial conditions of ux, x,u
    ...
    tau_rec = 750 #500 #750 #ms depress
    tau_facil = 50 #2000 #50 # ms facilitaion
 ...
 # array for recording data of k and (k+1) steps
    ...
    if isim%threads==rank:
        ...
        net = Networkmodel(Ne1 =Ne,   # The numbers of excitatroy ensemble
          ...
          W_ii1 = 0.03, # the weight of  itself inhibitory currents in inhibitory population
          W_ie1 = 0.02, # the weight of excitatory currents in inhibitory population from excitatory population
          )
    ...
    # the gap junction matrix 
        ...
        with open("Spikes_JeiJeevary_CHAOS40res1_I30STD15/Spikes_%04d_jee_%.2f_jei_%.2f.txt"%(isim,jee,jei),'w') as f:
